...
| v3.7.0 | Console Restructure | Collapse 6 tabs into Dashboard (Overview+Analytics merged) / Review / Admin menu; Submit -> header button + modal; role-aware landing. Frontend-only. | ~3-4h | PLANNED (next gate) |
